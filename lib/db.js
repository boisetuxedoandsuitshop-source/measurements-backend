...
// Run migrations automatically on first import
pool.query('ALTER TABLE measurements ADD COLUMN IF NOT EXISTS event_date DATE')
  .catch(err => console.error('Migration error (event_date):', err));
